...
public class MainController {
	...
	@RequestMapping(value="registerMem", method = RequestMethod.POST)
	public String registerMem(MemberDTO dto,Model model,MultipartFile profile) throws Exception {
		...
		File saveFile = new File(uploadPath+File.separator+"img",saveName);//저장할 폴더 이름 , 저장할 파일 이름
		try {
		...
		dto.setImg(File.separator+"img"+File.separator+saveName);
