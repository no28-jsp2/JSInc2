	...
	<div class="container" style="color: white">
		...
		<form class="form-horizontal" role="form" method="post"	action="registerMem" enctype="multipart/form-data">
			<div class="form-group">
				...
				<div class="col-lg-10" id="provision" align="left">
					<textarea class="form-control" rows="8" style="resize: none">약관동의
제1조 (목적)
본 약관은 JSInc. 주식회사(이하 '회사')가 고도 사이트(이하 ‘사이트’)를 통하여 인터넷상에서 제공하는 서비스(이하 ‘서비스’)를 이용하는 고객 (이하 '고객')간의 권리와 의무 및 책임 등 기타 제반사항을 규정함을 목적으로 합니다.
...
3. 이 약관 및 서비스의 이용과 관련된 분쟁에 관한 소송은 회사의 본사 소재지를 관할하는 법원에 제기합니다.
   ...
   if(this.files && this.files[0]) {
    ...
    reader.readAsDataURL(this.files[0]);}
				...
				<br>
				<div class="form-group" id="divEmpNo">
				...
				<div class="form-group" id="bitrh">
					<label for="inputbirth" class="col-lg-2 control-label">생년월일
						예)910525</label>
					<div class="col-lg-10">
	...
	<button type="button" class="btn btn-primary" onclick="email_()" value="N" id="emailVal">인증번호전송</button><span id="spanEmail"></span><br>
      ...
      //이메일 인증번호 전송
		...
		<div>
			<p class="text-center">
				<small><strong>업체명: JS Inc.</strong></small><br> <small>대표
					: 홍길동 ㆍ 주소 : 사거리 ㆍ 사업자등록번호:123-12-12345 ㆍ 전화 : 02-123-1234</small><br>
				<small>Copyrightⓒ JSInc.com All rights reserved.</small>
			</p>
		</div>
		<!--// 푸터 들어가는 부분 -->
	</div>
