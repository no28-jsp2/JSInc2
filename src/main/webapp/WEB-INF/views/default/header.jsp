...
<body>
	...
	<header class="header black-bg">
		...
		<!--logo start-->
		<a href="index" class="logo"><b>JS<span>Inc</span></b></a>
		<!--logo end-->
			...
			<ul class="nav top-menu">
				...
				<li id="header_inbox_bar" class="dropdown">
					...
					<ul class="dropdown-menu extended inbox">
						...
						<li>
							<a href="index.html#">
								<span class="photo">
									<img alt="avatar" src="resources/img/ui-zac.jpg"></span> <span class="subject">
						...
						<li>
							<a href="index.html#"> <span class="photo">
								<img alt="avatar" src="resources/img/ui-divya.jpg"></span>
								<span class="subject"> 
						...
						<li>
							<a href="index.html#"> 
								<span class="photo">
									<img alt="avatar" src="resources/img/ui-danro.jpg">
								</span>
								<span class="subject"> 
						...
						<li>
							<a href="index.html#"> 
								<span class="photo">
									<img alt="avatar" src="resources/img/ui-sherman.jpg"></span> 
									<span class="subject"> <span class="from">Dj Sherman</span> 
				...
				<li id="header_notification_bar" class="dropdown">
					...
					<ul class="dropdown-menu extended notification">
						...
						<li>
							<a href="index.html#"> <span class="label label-success"><i class="fa fa-plus"></i></span>
								New User Registered. 
